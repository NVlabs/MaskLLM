...
CHECKPOINT_LOAD_DIR="$PROJECT_DIR/assets/checkpoints/llama3.1_8b_megatron_tp8"
CHECKPOINT_SAVE_DIR="$PROJECT_DIR/output/oneshot_pruning/checkpoint/${NAME}"
TOKENIZER_MODEL="$PROJECT_DIR/assets/checkpoints/llama3.1_8b_hf"
