    ...
    for model_chunk in model_chunks:
        for name, param in model_chunk.named_parameters():
            ...
            if not no_wd and not scale_lr:
                _wd_mult, _lr_mult = 1.0, 1.0
            elif not no_wd and scale_lr:
                _wd_mult, _lr_mult = 1.0, lr_mult
            elif no_wd and not scale_lr:
                _wd_mult, _lr_mult = 0.0, 1.0
            else:
                _wd_mult, _lr_mult = 0.0, lr_mult
            
            print_rank_0(f"Learnable Param: {name}, wd_mult: {_wd_mult}, lr_mult: {_lr_mult}, is_expert_parallel: {is_expert_parallel}")
            params_map[(_wd_mult, _lr_mult, is_expert_parallel)].append(param)
